...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-6">
            <a href="index.php" class="active-nav circle-nav"><i class="fa-solid fa-van-shuttle"></i><span>ทัวร์</span></a>
                        ...
                        <div id="card" class="col-lg">
                            <div class="card bg-white p-3 mb-4 shadow img-fluid"
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    <div class="user-info">
                                        ...
                                        <div class="user-info__basic">
                                            ...
                                            <p class="text-muted mb-0" style="text-shadow: #C8C8C8 1px 1px 5px; font-size:16px; font-weight:700;">ราคาเช่า
                                ...
                                <span id="status" class="font-weight-bold mt-1"
                                    style="text-shadow: #C8C8C8 1px 1px 5px; font-size:18px;"><p style="color:green;"><?php echo $row["trans_staus"]; ?><p></span>
                                <div class="d-flex justify-content-between mt-4">
                                    <div>
                                        ...
                                        <span>
                                            <button type="button" onclick="window.location='reserve_form.php?id=<?php echo $row['trans_id']?>&company=<?php echo $row['trans_name']?>'" 
                                                id="reserve" class="btn btn-sm rounded-s font-13 font-600 gradient-highlight">จองที่นั่ง</a>
                                        </span>
                                </div>
                            </div>
                        </div>
