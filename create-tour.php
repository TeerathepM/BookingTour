...
<body class="theme-light">
                    ...
                    <div class="container pt-4 pb-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="input-style has-borders no-icon validate-field mb-4">
                                <input type="text" name="Input-Tour" class="form-control validate-text" id="form-Tour"
                            ...
                            <a href="Admin.php" type="button" class="btn btn-danger">ยกเลิก</a>
                        </form>
    ...
    <?php
            // Add Tour
            if(isset($_POST['Input-Tour']) && isset($_POST['Input-Price']) && isset($_POST['Input-detail']) && isset($_POST['Input-seat'])){
                $name_tour = $_POST['Input-Tour'];
                $price_tour = $_POST['Input-Price'];
                $detail_tour = $_POST['Input-detail'];
                $status_tour = $_POST['status-tour'];
                ...
                if($result){
                    $insert = "INSERT INTO tbtransports (`trans_name`,`trans_price`,`trans_detail`,`trans_staus`,`trans_seat`)
                                VALUES ('$name_tour','$price_tour','$detail_tour','$status_tour','$seat_tour')";
