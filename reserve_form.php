...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-6">
            <a href="index.php" class="active-nav circle-nav"><i
                    class="fa-solid fa-van-shuttle"></i><span>ทัวร์</span></a>
            <a href="#" class="active-nav"><i class="fa-solid fa-guitar"></i><span>อีเว้นท์</span></a>
            ...
            <div class="card card-style" style="width:45%; margin:auto auto">
                ...
                ?>
                    <div class="content mb-0">
                        ...
                        <form method="POST" action="reserve_success.php?count=<?php echo $fetch['trans_seat']?>"
                            ...
                            <div class="input-style has-borders no-icon mb-4">
                                <input type="date" class="form-control validate-text" id="form-date" name="Date">
                                <div><span style="color:blue"><i class="fa-solid fa-calendar"></i></span></div>
                            </div>
                            ...
                            <div class="input-style has-borders no-icon mb-4">
                                <input type="time" class="form-control validate-text" class="form-control"
                                    id="form-time" name="Time">
                                <div><span style="color:blue"><i class="fas fa-clock"></i></span></div>
                            </div>
                            ...
                            <div class="input-style has-borders no-icon mb-4">
                                <input type="text" class="form-control validate-text" class="form-control"
                                    id="form-price" name="seat-price" value="<?php echo $fetch['trans_price']?>"
                                    readonly>
                            </div>
                            ...
                            <div>
                                <input type="range" class="ios-slider" min="1" max="<?php echo $fetch['trans_seat']?>"
                                    value="1" name="seat-count" id="customRange2">
                            ...
                            <div class="input-style has-borders no-icon mb-4">
                                ...
                                <button type="button" class="btn btn-danger"
                                    style="float:right; margin-right:5px" onclick="<?php echo "window.location='index.php'"; ?>">ยกเลิก</a>
...
// แสดงผลช่องรวมเงิน
var txt = document.getElementById("customRange2").value * <?php echo $fetch['trans_price']?>;
