...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-6">
            <a href="index.php" class="active-nav"><i class="fa-solid fa-van-shuttle"></i><span>ทัวร์</span></a>
            <a href="#" class="active-nav circle-nav"><i class="fa-solid fa-guitar"></i><span>อีเว้นท์</span></a>
                            ...
                            <div class="card bg-white p-3 mb-4 shadow img-fluid"
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    <div class="user-info">
                                        ...
                                        <div class="user-info__basic">
                                            <p class="mb-1" style="text-shadow: #C8C8C8 1px 1px 5px; font-size:20px; font-weight:700; color:green;">
                                                <?php echo $row["event_name"]; ?>
                                            </p>
                                            <p class="text-muted mb-0" style="text-shadow: #C8C8C8 1px 1px 5px; font-size:16px; font-weight:700;">ราคา
                                                <?php echo $row["event_price"]; ?> ต่อตั๋ว</p>
                                        </div>
                                    </div>
                                </div>
                                <p class="mb-0" style="text-shadow: #C8C8C8 1px 1px 5px; font-size:16px; font-weight:600;">
                                    <?php echo $row["event_detail"]; ?>
                                </p>
                                <span id="status" class="font-weight-bold mt-1"
                                    style="text-shadow: #C8C8C8 1px 1px 5px; font-size:18px;"><p style="color:green;"><?php echo $row["event_status"]; ?><p>
                                </span>

                                <span id="date" class="font-weight-bold mt-1"
                                style="text-shadow: #C8C8C8 1px 1px 5px; font-size:18px;"><p style="color:green;"><?php echo "ว/ด/ป ". $row["event_date"]; ?>  <?php echo " เวลา ". $row["event_time"]; ?><p>
                                </span>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <div>
                                        ...
                                        <span>
                                            <button type="button" onclick="window.location='payment.php?id=<?php echo $row['event_id']?>&company=<?php echo $row['event_name']?>'" 
                                                id="reserve" class="btn btn-sm rounded-s font-13 font-600 gradient-highlight">จองตั๋ว</a>
                                        </span>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Main Menu-->
        <div id="menu-main" class="menu menu-box-left rounded-0" data-menu-load="html/menu-main.html" data-menu-width="280"
            data-menu-active="nav-components"></div>
